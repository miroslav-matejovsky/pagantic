...
/*
Package api implements an external interaction adapter for the Pagantic system.
...
The api adapter is a thin boundary layer between external user interaction
